...
public class Drive extends CommandBase {
  ...
  @Override
  public void execute() {
    m_driveSubsystem.drive(RebelUtil.linearDeadband(xboxDriver.getLeftY(), 0.1) * MAX_FORWARD_SPEED, RebelUtil.linearDeadband(-xboxDriver.getRightX(), 0.1) * MAX_TURN_SPEED);
  }
