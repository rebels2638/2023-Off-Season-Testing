 ...
 */
public final class ConstantsSRXDriveTrain {
    ...
    public static final class DriveConstants {
        ...
        // Left gearbox
        public static final int FALCON_LEFT_FRONT_ID = 1; // 13 1
        public static final int FALCON_LEFT_BACK_ID = 2; // 12 2
        public static final boolean FALCON_LEFT_FRONT_INVERTED = false;
        public static final boolean FALCON_LEFT_BACK_INVERTED = false;

        // Right gearbox
        public static final int FALCON_RIGHT_FRONT_ID = 3; // 14 3
        public static final int FALCON_RIGHT_BACK_ID = 4; // 15 4
        public static final boolean FALCON_RIGHT_FRONT_INVERTED = true;
        public static final boolean FALCON_RIGHT_BACK_INVERTED = true;
