...
public class DrivetrainFalcon extends SubsystemBase {
  ...
  private final MotorController m_leftLeader = new WPI_TalonSRX(DriveConstants.FALCON_LEFT_FRONT_ID);
  private final MotorController m_leftFollower = new WPI_TalonSRX(DriveConstants.FALCON_LEFT_BACK_ID); 
  private final MotorController m_rightLeader = new WPI_TalonSRX(DriveConstants.FALCON_RIGHT_FRONT_ID);
  private final MotorController m_rightFollower = new WPI_TalonSRX(DriveConstants.FALCON_RIGHT_BACK_ID);
